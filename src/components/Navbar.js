    ...
    <>
      <nav className="App-navbar d-flex justify-content-between fixed-top shadow" style={{ backgroundColor: '#303960', color: 'white', fontFamily: 'Exo' }} >
        ...
        <div className="my-2 mx-4">
          <Link to="/home"><img src={logo} alt="worldsounds" style={{ width: '6em' }} ></img></Link>
        </div>
      ...
      </nav>
      {
          ...
          &&
          <div className="card end-0 overflow-scroll" style={{ marginRight: '18px', marginTop: '0.2em', width: '223px', position: 'fixed', zIndex: '1' }}>
