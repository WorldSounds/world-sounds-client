    ...
    <div className="landing" >
      <Link to="/home">
        <div className="welcome">
          ...
          <h3 data-aos="fade-up" data-aos-duration="3000" style={{ color: 'white' }} >explore, play, & search</h3>
        </div>
      </Link>
      ...
      <div className="content"  data-aos="zoom-in"  data-aos-duration="1000" style={{ backgroundColor: 'rgba(14, 18, 66, 1)', padding: '20px', height: '500px' }}>
        ...
        <div className="gradient" style={{ height: '1680px', background: 'linear-gradient( rgba(14, 18, 66, 1), rgba(69, 182, 144, 1))', fontFamily: 'Exo' }}>
          ...
          <div style={{ position: "relative" }} >
            <div className="" data-aos="fade" data-aos-delay="500"  data-aos-duration="1000" style={{ position: 'absolute', top: '20%', left: '40%', margin: '-100px 20 -10 -170px',  zIndex: '1',  }}>
