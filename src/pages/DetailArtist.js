...
import {inputArtist, getArtist} from '../store/actions/artistAction' 
import '../App.css'
...
export default function DetailArtist() {
      ...
      return(
        <div>
          <Navbar />
          <div >
          <div className=" d-flex col position-absolute top-0 start-50 translate-middle-x " style={{marginTop: '100px', border: 'solid rgba(69, 182, 144, 1)', width: '680px' }}>
            <div>
              <img src={artist.images} alt={artist.name} style={{ width: '300px',  border: ' 5px solid white', margin: '18px',  }} ></img>
            </div>
            <div className="mt-3" style={{ textAlign: 'left', color: 'white', margin: '20px', fontFamily: 'Roboto' }}>
              <div>
